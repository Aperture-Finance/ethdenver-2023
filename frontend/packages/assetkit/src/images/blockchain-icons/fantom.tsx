...
export const FantomIcon: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath={`url(#${props.id}_fantom_clip0)`}>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M10.5411 20H9.48622C4.20856 19.7257 0.0136719 15.3596 0.0136719 10.0137C0.0136719 4.49082 4.49082 0.0136719 10.0137 0.0136719C15.3596 0.0136719 19.7257 4.20856 20 9.48622V10.5411C19.7348 15.6441 15.6441 19.7348 10.5411 20Z"
          fill={`url(#${props.id}_fantom_pattern0)`}
        />
      </g>
      <defs>
        <pattern
          id={`${props.id}_fantom_pattern0`}
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use
            xlinkHref={`#${props.id}_fantom_image0`}
            transform="scale(0.005)"
          />
        </pattern>
        <clipPath id={`${props.id}_fantom_clip0`}>
          <rect width="20" height="20" fill="white" />
        </clipPath>
        <image
          id={`${props.id}_fantom_image0`}
          width="200"
          height="200"
