...
export const PendingIcon: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <svg
    ...
    >
      <path
        ...
        fill={`url(#${props.id}_pending_paint0)`}
      />
      <path
        ...
        fill={`url(#${props.id}_pending_paint1)`}
      />
      <defs>
        <linearGradient
          id={`${props.id}_pending_paint0`}
          x1="1.62529"
          y1="11.1878"
          x2="13.6971"
          y2="6.75328"
        ...
        >
          <stop stopColor="#A88EF5" />
          <stop offset="1" stopColor="#77DFF2" />
        </linearGradient>
        <linearGradient
          id={`${props.id}_pending_paint1`}
          x1="5.49214"
          y1="14.4377"
          x2="17.1421"
          y2="10.0061"
